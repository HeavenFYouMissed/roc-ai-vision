...
# Setting up Reshade [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#setting-up-reshade "Permalink to this headline")
...
## Video [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#video "Permalink to this headline")
...
## Setting up Reshade for the game [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#setting-up-reshade-for-the-game "Permalink to this headline")
...
## Configuring Reshade [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#configuring-reshade "Permalink to this headline")
...
are for. If you decided to download shaders when setting up Reshade you'll see all the _techniques_ these shaders contain listed in a nice order on the
**Home** tab. You can assign hotkeys for each technique by right-clicking the name and clicking in the textbox next to _Toggle Key_.
...
the technique name with the mouse. When a technique is active, its controls are listed at the bottom of the _Home_ tab. You can drag the horizontal blue bar
upwards to make some space.

### Undock the menu [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#undock-the-menu "Permalink to this headline")
...
### Order of execution [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#order-of-execution "Permalink to this headline")

The techniques on the _Home_ tab seem to be listed in a random order, but that's not the case. The order of execution is from top to bottom. This means that
...
### Setting up global preprocessor definitions. [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#setting-up-global-preprocessor-definitions. "Permalink to this headline")
...
edit these definitions by clicking the blue 'Edit global preprocessor definitions' button right at the top of the technique parameters on the _Home_ tab.
What these settings mean is explained in the section [Checking depth buffer access](https://framedsc.com/ReshadeGuides/setupreshade.htm#checking-depth-buffer-access).

### Reshade settings [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#reshade-settings "Permalink to this headline")

You can configure the various settings of Reshade on its Settings tab. For us screenshotters the _Screenshots_ section is particularly important.
...
## Changing a technique's parameters [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#changing-a-techniques-parameters "Permalink to this headline")
...
by checking the checkbox in front of the technique's name on the _Home_ tab. You'll see that Reshade will display all settings for a shader below the blue splitter bar
on the _Home_ tab.
...
## Checking depth buffer access [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#checking-depth-buffer-access "Permalink to this headline")
...
### Picking the right depth buffer [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#picking-the-right-depth-buffer "Permalink to this headline")
...
This additional tab shows all currently active depth buffers. To see which one you should select, first enable the _DisplayDepth_ shader. You likely either see a white or a black screen. When you go to the additional tab mentioned above in the Reshade menu/overlay you can then pick the right depth buffer by checking its checkbox (or by trying the _Copy depth before clearing_ checkbox). If the screen becomes what it should be, you picked the right depth buffer and you can use it with the techniques that depend on it.

## Shader duplication [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#shader-duplication "Permalink to this headline")
...
## Depth buffer on online games [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#depth-buffer-on-online-games "Permalink to this headline")
...
## Using reshade alongisde other injectable mods [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#using-reshade-alongisde-other-injectable-mods "Permalink to this headline")
...
## Further information [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#further-information "Permalink to this headline")
...
## Custom shader repositories [Permalink to this headline](https://framedsc.com/ReshadeGuides/setupreshade.htm\#custom-shader-repositories "Permalink to this headline")
